...
namespace PR_Top_Service_MVC.Controllers
{
    ...
    public class CustomerUserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCostumer,Address,Ci,CellphoneNumber,Latitude,Longitud,IdPerson,Name,LastName,SecondLastName,IdDepartment,status,IdUser,Email,Password,Role")] CustomerUser customerUser)
        {

            var existingUser = await _context.Users.FirstOrDefaultAsync(u => u.Email == customerUser.Email);
            if (existingUser != null)
            {
                ...
                return View(customerUser); // Muestra la vista de registro con el mensaje de error
            }
            else
            {
                Person p = new()
                ...
                Costumer c = new()
                {
                    ...
                    Longitud = customerUser.Longitud,
                    CellphoneNumber = customerUser.CellphoneNumber
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCostumer,Address,Ci,CellphoneNumber,Latitude,Longitud,IdPerson,Name,LastName,SecondLastName,IdDepartment,status,IdUser,Email,Password,Role")] CustomerUser customerUser)
        {
            ...
            try
            {
                ...
                if (customerUser.CellphoneNumber != null)
                {
                    costumer.CellphoneNumber = customerUser.CellphoneNumber;
                }
